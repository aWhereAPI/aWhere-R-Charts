...
#'
#' @details This function makes extends the aWhere charts package to plot the ETCCDI climate
...
generateAndPlotClimateIndex <- function(data
  ...
  for (z in 1:length(variable.all)) {
    if (grepl(pattern = 'maxLenDrySpell|Maximum Length of Dry Spell|maxLenWetSpell|Maximum Length of Wet Spell'
      ...
      index.title <- paste0('Summery day temperature set at ',indexSpecificValue,'C\n')
